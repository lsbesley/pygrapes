...
## Installation
Clone the Git Repository and run the test jupyter notebook "Demo_sim_Script_1incangle-pygrapes.ipynb" to verify the installation is working. This also serves as a tutorial to show how to use PyGRAPES on your own data.
